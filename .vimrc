...
" включаем режим автоматической проверки изменения файла
set autoread
...
call vundle#rc()
" перечисляем плагины, которые нужно установить и обновлять:
" Bundler для VIM
...
" Поиск по файлам, часто используемым файлам, буферам
let g:ctrlp_cmd = 'CtrlPMixed'

" Интерактивный режим работы клавиатуры при русской раскладке
set langmap=ёйцукенгшщзхъфывапролджэячсмитьбюЁЙЦУКЕHГШЩЗХЪФЫВАПРОЛДЖЭЯЧСМИТЬБЮ;`qwertyuiop[]asdfghjkl\\;'zxcvbnm\\,.~QWERTYUIOP{}ASDFGHJKL:\\"ZXCVBNM<>

" Для копирования в буфер обмена
set clipboard=unnamedplus

" Neocomplcashe settings
